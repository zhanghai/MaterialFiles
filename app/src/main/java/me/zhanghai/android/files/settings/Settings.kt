...
object Settings {
    ...
    val FILE_LIST_SHOW_RECENT_FILES: SettingLiveData<Boolean> =
        BooleanSettingLiveData(
            R.string.pref_key_file_list_show_recent_files,
            R.bool.pref_default_value_file_list_show_recent_files
        )
