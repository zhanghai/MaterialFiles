...
import me.zhanghai.android.materialfilemanager.functional.compat.DoublePredicate;
...
public interface ThrowingDoublePredicate extends DoublePredicate {
     ...
     */
    default ThrowingDoublePredicate and(ThrowingDoublePredicate other) {
     ...
     * predicate
     */
    default ThrowingDoublePredicate negate() {
     ...
     * @throws NullPointerException if other is null
     */
    default ThrowingDoublePredicate or(ThrowingDoublePredicate other) {
        Objects.requireNonNull(other);
        return (value) -> testThrows(value) || other.testThrows(value);
    }
}
