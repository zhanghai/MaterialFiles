...
import me.zhanghai.android.materialfilemanager.functional.compat.LongPredicate;
...
public interface ThrowingLongPredicate extends LongPredicate {
     ...
     */
    default ThrowingLongPredicate and(ThrowingLongPredicate other) {
     ...
     * predicate
     */
    default ThrowingLongPredicate negate() {
     ...
     * @throws NullPointerException if other is null
     */
    default ThrowingLongPredicate or(ThrowingLongPredicate other) {
        Objects.requireNonNull(other);
        return (value) -> testThrows(value) || other.testThrows(value);
    }
}
