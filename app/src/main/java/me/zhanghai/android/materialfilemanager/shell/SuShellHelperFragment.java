...
public class SuShellHelperFragment extends Fragment {
    ...
    @NonNull
    public static SuShellHelperFragment attachToActivity(@NonNull Fragment fragment) {
        return attachTo(fragment.requireActivity());
    }

    @NonNull
    private static SuShellHelperFragment attachTo(@NonNull FragmentActivity activity) {
