...
import me.zhanghai.android.materialfilemanager.functional.compat.ObjLongConsumer;

/**
 * Represents an operation that accepts an object-valued and a
 * {@code long}-valued argument, and returns no result.  This is the
 * {@code (reference, long)} specialization of {@link ThrowingBiConsumer}.
 * Unlike most other functional interfaces, {@code ThrowingObjLongConsumer} is
