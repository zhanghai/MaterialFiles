...
import me.zhanghai.android.materialfilemanager.functional.compat.ObjIntConsumer;

/**
 * Represents an operation that accepts an object-valued and a
 * {@code int}-valued argument, and returns no result.  This is the
 * {@code (reference, int)} specialization of {@link ThrowingBiConsumer}.
 * Unlike most other functional interfaces, {@code ThrowingObjIntConsumer} is
