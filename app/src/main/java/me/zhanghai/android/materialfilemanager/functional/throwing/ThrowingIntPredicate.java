...
import me.zhanghai.android.materialfilemanager.functional.compat.IntPredicate;
...
public interface ThrowingIntPredicate extends IntPredicate {
     ...
     */
    default ThrowingIntPredicate and(ThrowingIntPredicate other) {
     ...
     * predicate
     */
    default ThrowingIntPredicate negate() {
     ...
     * @throws NullPointerException if other is null
     */
    default ThrowingIntPredicate or(ThrowingIntPredicate other) {
        Objects.requireNonNull(other);
        return (value) -> testThrows(value) || other.testThrows(value);
    }
}
