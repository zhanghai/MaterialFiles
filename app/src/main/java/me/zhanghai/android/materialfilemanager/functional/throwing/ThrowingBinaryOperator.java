...
public interface ThrowingBinaryOperator<T> extends ThrowingBiFunction<T,T,T> {
     ...
     * @return a {@code ThrowingBinaryOperator} which returns the lesser of its operands,
     ...
     * @param <T> the type of the input arguments of the comparator
     * @param comparator a {@code Comparator} for comparing the two values
     * @return a {@code ThrowingBinaryOperator} which returns the greater of its operands,
     *         according to the supplied {@code Comparator}
     * @throws NullPointerException if the argument is null
     */
